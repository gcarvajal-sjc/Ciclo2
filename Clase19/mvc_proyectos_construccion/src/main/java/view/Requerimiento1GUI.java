...
public class Requerimiento1GUI extends JFrame {
    ...
    // Controlador
    // public static final ControladorProyectosConstruccion controlador = new
    // ControladorProyectosConstruccion();
    // public static final ControladorRequerimientosReto4 controlador = new
    ...
    public Requerimiento1GUI(ArrayList<MaterialNacional> materiales, ControladorRequerimientosReto4 controlador) {
        ...
        jtTablaRequerimiento1 = new JTable(this.formatoMaterialesNacionales(materiales, encabezados.length),
                encabezados);
